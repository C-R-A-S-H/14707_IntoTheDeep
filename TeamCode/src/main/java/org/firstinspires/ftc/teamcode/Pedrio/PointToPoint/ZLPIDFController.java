...
public class ZLPIDFController {
     ...
     */
    public ZLPIDFController(double kp, double ki, double kd, double kf) {
     ...
     */
    public ZLPIDFController(double kp, double ki, double kd, double kf, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
