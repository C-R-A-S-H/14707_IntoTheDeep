...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.34845;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 0.003127403096038503;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = 0.027;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(2, 7.5, 0);
        rightEncoderPose = new Pose(2, -7.5, 0);
        strafeEncoderPose = new Pose(-4, 0, Math.toRadians(90));
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "middleEncoder"));
